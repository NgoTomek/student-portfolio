    ...
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          <div className="text-center">
            ...
            <p className="mt-6 max-w-md mx-auto text-sm sm:text-base md:text-lg md:max-w-3xl italic">
              "{portfolio.personalInfo?.quote || "Education is the passport to the future, for tomorrow belongs to those who prepare for it today."}"
            </p>
          </div>
        </div>
      </div>
                ...
                <ul className="space-y-3">
                  {portfolio.contact?.email && (
                    <li className="flex items-center">
                      ...
                      <a href={`mailto:${portfolio.contact.email}`} className="text-blue-600 hover:text-blue-800">
                        {portfolio.contact.email}
                      </a>
                    </li>
                  )}
                  ...
                  {portfolio.contact?.phone && (
                    <li className="flex items-center">
                      ...
                      <a href={`tel:${portfolio.contact.phone}`} className="text-blue-600 hover:text-blue-800">
                        {portfolio.contact.phone}
                      </a>
                    </li>
                  )}
                  ...
                  {portfolio.contact?.website && (
                    <li className="flex items-center">
                      ...
                      <a href={portfolio.contact.website} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">
                        {portfolio.contact.website}
                      </a>
                    </li>
                  )}
      ...
      <footer className="bg-gray-800 text-white py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <p className="text-sm">
              &copy; {new Date().getFullYear()} {portfolio.personalInfo?.name || userProfile.displayName} • Student Portfolio
            </p>
          </div>
        </div>
      </footer>
