    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <a href="/dashboard/projects" className="text-blue-600 hover:text-blue-800 font-medium">
            Edit Projects →
          </a>
        </div>
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <a href="/dashboard/leadership" className="text-blue-600 hover:text-blue-800 font-medium">
            Edit Leadership →
          </a>
        </div>
      </div>
