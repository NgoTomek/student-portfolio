              ...
              <div className="md:flex">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 mt-2 mb-4">
                    ...
                    enhancing communication between students and staff, and promoting sustainability
                    initiatives.
                  </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600 mb-3">
                Active member of the school debate team, participating in local and regional
                competitions.
              </p>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600 mb-3">
                Competed in chemistry and physics events, winning bronze medal in regional
                competition.
              </p>
