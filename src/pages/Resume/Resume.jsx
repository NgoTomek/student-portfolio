      ...
      <div className="max-w-4xl mx-auto">
        ...
        <section className="mb-16">
          <SectionTitle 
            ...
            subtitle="Professional summary and experience"
          />
            ...
            <div className="mb-8">
              ...
              <div className="mb-6">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className="bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded-full">2020-Present</span>
                </div>
              ...
              <div>
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className="bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded-full">2015-2020</span>
                </div>
                <p className="text-gray-600 mb-2">GCSEs (2020)</p>
                <p className="text-gray-600">9 GCSEs including Mathematics (9), English Language (8), English Literature (8), Science (9,8)</p>
              </div>
            </div>
            
            {/* Experience */}
            <div className="mb-8">
              <h3 className="text-xl font-bold text-gray-800 mb-4 border-b border-gray-200 pb-2">Experience</h3>
              ...
              <div>
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className="bg-green-100 text-green-800 text-xs px-2 py-1 rounded-full">Summer 2023</span>
                </div>
